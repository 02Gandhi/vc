            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-brand-background p-6">
                    <div className="container mx-auto">
                        <BackButton />
                        <h1 className="text-3xl font-bold text-brand-text-primary mb-2">Магазин кредитов</h1>
                        <p className="text-brand-text-secondary mb-8">Выберите пакет для пополнения баланса и подачи заявок на проекты.</p>
